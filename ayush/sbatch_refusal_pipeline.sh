#!/bin/bash
#SBATCH --job-name=refusal_pipeline
...
#SBATCH --output=/scratch/ak13124/attention_dilution/logs/refusal_pipeline_%j.out
#SBATCH --error=/scratch/ak13124/attention_dilution/logs/refusal_pipeline_%j.err
...
#   sbatch ayush/sbatch_refusal_pipeline.sh
# or from inside ayush/:
#   sbatch sbatch_refusal_pipeline.sh
...
echo \"=== refusal_pipeline | job \${SLURM_JOB_ID:-local} ===\"
echo \"Repo: \$(pwd)\"
